...
// @ts-ignore
import imageViewerScript from "../../components/scripts/imageViewer.inline"
...
function addGlobalPageResources(ctx: BuildCtx, componentResources: ComponentResources) {
  ...
  componentResources.afterDOMLoaded.push(imageViewerScript)
  ...
  componentResources.afterDOMLoaded.push(`
    ...
    if (document.documentElement.dataset.backToTopBound !== "true") {
      ...
      document.addEventListener("nav", () => requestAnimationFrame(updateBackToTop))
    }
